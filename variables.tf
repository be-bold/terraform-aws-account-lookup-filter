...
variable "include" {
  ...
  validation {
    condition = var.include.name == null || (var.include.name != null && try(contains(["startswith", "endswith", "equals"], var.include.name.matcher), false))
...
variable "exclude" {
  ...
  validation {
    condition = var.exclude.name == null || (var.exclude.name != null && try(contains(["startswith", "endswith", "equals"], var.exclude.name.matcher), false))
